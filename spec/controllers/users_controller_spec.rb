...
describe UsersController do
  ...
  describe "GET 'index'" do
    ...
    describe "for signed in users" do
      ...
      it "should have no delete links for non-admins" do
        other_user = User.all.second
        get :index
  ...
  describe "GET 'show'" do
    ...
    it "should show the user's microposts" do
      mp1 = Factory(:micropost, :user => @user, :content => "cheese and rice")
      mp2 = Factory(:micropost, :user => @user, :content => "werd werd werd")
  ...
  describe "Post 'create'" do
    ...
    describe "success" do
      before(:each) do
        @attr = { :name => "kobe", :email => "kobe@lakers.com", 
                  :password => "blackmamba", :password_confirmation => "blackmamba"}
      end
