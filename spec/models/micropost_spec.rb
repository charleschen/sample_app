...
describe Micropost do
  ...
  describe "from_users_followed_by" do
    ...
    before(:each) do
      ...
      @user_post    = @user.microposts.create!(:content => "werd")
      @other_post   = @other_user.microposts.create!(:content => "anit-werd")
      @third_post   = @third_user.microposts.create!(:content => "here we go!")
