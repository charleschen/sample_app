...
describe User do
  ...
  it "should require a name" do
    ...
    no_name_user.should_not be_valid # be_ is bolean version of said method
  end
  ...
  describe "password encryption" do
    ...
    describe "authenticate method" do
      ...
      it "should return nil for an email address with no user" do
        User.authenticate("bad@email.com", @attr[:password]).should be_nil
      end
  ...
  describe "micropost associations" do
    before(:each) do
      ...
      # factories are able to bypass to set :create_at, normally cannot with .create!
      @mp1 = Factory(:micropost, :user => @user, :created_at => 1.day.ago)
      @mp2 = Factory(:micropost, :user => @user, :created_at => Time.now)
    end
    ...
    it "should have the right microposts in the right order" do
      # test it's an array and the right order
    ...
    describe "status feed" do
      ...
      it "should inlcude user's micropost" do
  ...
  describe "relationships" do
    ...
    it "should follow another user" do
      @user.follow!(@followed)  # user should be following followed user
    ...
    it "should include teh follower in the following array" do
      @user.follow!(@followed)
